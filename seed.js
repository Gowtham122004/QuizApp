...
/*  ← keep your big nested array exactly as-is */ ];

const flatQuestions = questionsData.flatMap(entry =>
...
(async function seedDB() {
  try {
    await mongoose.connect("mongodb+srv://quizuser:quiz1234@cluster0.g9qau7k.mongodb.net/quizapp?retryWrites=true&w=majority&appName=Cluster0", {
